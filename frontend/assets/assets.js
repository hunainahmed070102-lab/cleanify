...
import cleaning_img from "./cleaning.png"
import cleaning_service_jpeg from "./cleaning_service.jpeg"
import removal_img from "./removal.png"
import disposal_img from "./disposal.png"
...
export const assets = {
    upload_area, hero_model_img, cleaning_img, cleaning_service_jpeg, removal_img, disposal_img,
    hero_product_img1, hero_product_img2, gs_logo,
    product_img1, product_img2, product_img3, product_img4, product_img5, product_img6,
    product_img7, product_img8, product_img9, product_img10, product_img11, product_img12,
    hero_video: "/assets/hero-video.webm", // Video placeholder - add your video file to public/assets/
}
...
export const ourSpecsData = [
    { title: "Satisfaction Guaranteed", description: "We'll re-clean or re-do the service at no extra cost if you're not satisfied.", icon: SendIcon, accent: '#05DF72' },
    { title: "Payment After Service", description: "Pay only after the service is completed to your complete satisfaction.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "24/7 Customer Support", description: "Get quick assistance and support anytime through WhatsApp.", icon: HeadsetIcon, accent: '#A684FF' }
]
